...
dataset = pd.read_csv(
    r"D:\loki\backup project\New_Projects Backup\30. Symptom based Disease prediction using Machine Learning\SOURCE CODE/Training.csv")
...
df_test = pd.read_csv(
    r"D:\loki\backup project\New_Projects Backup\30. Symptom based Disease prediction using Machine Learning\SOURCE CODE/Testing.csv")
